...
import csv
FILENAME= "data.csv"
DATADIR = "../my-work/"        # locate the file location using cmd, then use the following format to locate directory r"C:\Users\marou\Desktop\programming-for-data-analytics\my-work\\"
...
# a List, Square Brackets [] for Lists
