...
Galway - Mace Head station is a particularly relevant case study, having received the highest number of wind warnings in Ireland since 2020.  
...
This project examines historical wind data for Galway to identify trends over time, including daily, monthly and seasonal variations, it also explores simple predictions of future wind patterns.  
...
- [✔️] **Problem Definition**   
    Define the project goal/scope of analyzing Galway windspeed.  
- [✔️] **Data Collection**  
